        ...
        <>
            <div className={styles.navbar}>
                ...
                <svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                    ...
                    <path d="M73.4 297.4C60.9 309.9 60.9 330.2 73.4 342.7L233.4 502.7C245.9 515.2 266.2 515.2 278.7 502.7C291.2 490.2 291.2 469.9 278.7 457.4L173.3 352L544 
                ...
                <svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                    {/*<!--!Font Awesome Free v7.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->*/}
                    <path d="M96 160C96 142.3 110.3 128 128 128L512 128C529.7 128 544 142.3 544 160C544 177.7 529.7 192 512 192L128 192C110.3 192 96 177.7 96 160zM96 320C96 302.3 
            ...
            <div className={styles.menu}>
                <ol className={styles.list}>
                    <li><button className={styles.button}>Add Player</button></li>
                    <li><button className={styles.button}>Delete Player</button></li>
                    <li><button className={styles.button}>Edit Player</button></li>
                </ol>
            </div>
            <ScoreKeeper
                name="connor"
