    ...
    return (
        <>  
            <div className={styles.container}>
                <h1 className={`${styles.title} ${styles.fillTextEffect}`}>Games</h1>
            ...
            <div className={styles.container}>
                <h1 className={`${styles.title} ${styles.fillTextEffect}`}>Tools</h1>

                <div className={styles.toolsContainerContainer}>
