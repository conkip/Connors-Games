...
const Dice = ({color="white", size=4, setFaceState}:Props)=> {
    ...
    return (
        <div className={styles.overallContainer} style={{ "--coin-size": `${size}rem`, "transform": `rotate(${rotation}deg)`, "transition": "transform 0.3s ease"} as React.CSSProperties } onClick={handleClick} onTransitionEnd={handleTransitionEnd}>
            {face === 1 && 
            <div className={`${styles.container} ${styles.d1}`} style={{background:`${color}`}}>
                <div className={styles.circle}></div>
            </div>}

            {face === 2 && 
            <div className={`${styles.container} ${styles.d2}`} style={{background:`${color}`}}>
                <div className={`${styles.circle} ${styles.d2d1}`}></div>
                <div className={`${styles.circle} ${styles.d2d2}`}></div>
            </div>}

            {face === 3 && 
            <div className={`${styles.container} ${styles.d3}`} style={{background:`${color}`}}>
            ...
            {face === 4 && 
            <div className={`${styles.container} ${styles.d4}`} style={{background:`${color}`}}>
