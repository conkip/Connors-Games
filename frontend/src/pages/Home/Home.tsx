                ...
                <div className={styles.topContainer}>
                    ...
                    <div className={styles.inner}>
                        <Marquee height={5} width= {5}>
                            ...
                            {/*Dice*/}
                            <Link className={styles.link} to="/tools/dice"><Dice size={5} /></Link>
                        ...
                        <h2>Use <h2 className={styles.colorText}>built in tools</h2> like a <h2 className={styles.colorText}>score keeper</h2> or dice roller</h2>
                    </div>
                </div>
            </div>
