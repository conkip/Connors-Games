...
const NavItem = forwardRef<HTMLButtonElement, Props>(({ children, expandable = false, onClick, active }, ref) => {
    ...
    return (
        <button ref={ref} type="button" className={`${styles.container} ${active && expandable ? styles.active : ""}`} onClick={handleClick}>
